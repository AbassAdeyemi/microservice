...
import com.hayba.microservices.query.service.dataaccess.repository.UserPermissionRepository;
...
public class TwitterQueryUserService implements QueryUserService {
    ...
    public Optional<List<UserPermission>> findAllPermissionsByUsername(String username) {
        ...
        return userPermissionRepository.findUserByUsername(username);
    }
}
