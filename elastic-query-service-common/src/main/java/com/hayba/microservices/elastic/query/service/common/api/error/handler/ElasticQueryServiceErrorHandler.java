package com.hayba.microservices.elastic.query.service.common.api.error.handler;
...
public class ElasticQueryServiceErrorHandler {
    private final Logger LOG = LoggerFactory.getLogger(ElasticQueryServiceErrorHandler.class);
    ...
    public ResponseEntity<String> handle(RuntimeException e) {
        ...
        return ResponseEntity.badRequest().body("Server runtime exception");
    }
