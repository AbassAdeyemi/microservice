...
public class WebClientConfig {
    ...
    private final ElasticQueryWebClientConfig.WebClient webClientConfig;

    public WebClientConfig(ElasticQueryWebClientConfig.WebClient webClientConfig) {
        ...
        return WebClient.builder()
                ...
                .codecs(clientCodecConfigurer ->
                        clientCodecConfigurer
                                .defaultCodecs()
                                .maxInMemorySize(webClientConfig.getMaxInMemorySize())).build();
    }
